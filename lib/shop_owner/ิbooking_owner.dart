...
class Bookink_owner extends StatefulWidget {
  final String service;
  Bookink_owner({required this.service});

  @override
  State<Bookink_owner> createState() => _Bookink_ownerState();
}

class _Bookink_ownerState extends State<Bookink_owner> {
